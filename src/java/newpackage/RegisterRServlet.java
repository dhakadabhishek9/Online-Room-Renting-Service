    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if(email.length()!=10)
            {
             out.println("<script type=\"text/javascript\">");
                ...
                out.println("location='RegisterRoomie.jsp';");
                out.println("</script>");   
            }else{
            String que="select * from roomie where email="+email;
            ...
            String query = "insert into roomie(name,email,password,image,city,address,gender,latitude,longitude,rent,living)"
                   + " values(?,?,?,?,?,?,?,?,?,?,?)";
