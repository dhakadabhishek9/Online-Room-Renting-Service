...
<body>
    ...
    try {
          String emai=request.getSession().getAttribute("email").toString();
            ...
            String query="Select * from owners where email='"+emai+"'";
...
document.getElementById("<%=rs.getString("gender")%>").checked=true;
    ...
    <form name="f1" action="UpdateOServlet" method="post" h:form enctype="multipart/form-data">
        <button class="form-button" style="width:21%"><a href="index.jsp">Home</a></button>
<h2 class="form-header">Owner Profile</h2>
...
<tr>
<td colspan="2" align="center"><img src="profileimage.jsp" style="width: 600px; height: 500px"></div></td>
</tr>
<tr>
<td>Change image :</td>
...
<form action="DeleteServlet" method="post" align="center">
