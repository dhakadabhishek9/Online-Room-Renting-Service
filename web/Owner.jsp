...
(min-device-width: 768px) and (max-device-width: 1024px)  {
    ...
    <% 
    try {String city=request.getParameter("cityo");
            Connection connn=ConnDao.getConnection();
        Statement stmt = connn.createStatement(); 
        ResultSet rst = stmt.executeQuery("SELECT * FROM owners where city='"+city+"'"); 
        %>
        <form action="DetailServlet" method="post" h:form enctype="multipart/form-data">
